...
class Receipt(BaseModel):
    ...
    price:float = Field(description="price of this item. If multiple nuumbers are bought, then total price of this item")
...
prompt = PromptTemplate.from_template("This is the receipt, can you organize this? {receipt}")
